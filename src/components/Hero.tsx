    ...
    return (
        <section id="home" className="relative min-h-screen flex items-center justify-center">
            <div className="max-w-3xl px-6 sm:px-8 -ml-16 text-left">
                <p className="tracking-[0.2em] text-xs sm:text-sm text-neutral-500 dark:text-neutral-400">
                    🚀 MSc Research Grad.
                </p>

                <h1 className="mt-4 text-[48px] sm:text-[88px] leading-[0.95] font-medium text-neutral-900 dark:text-neutral-100">
                    Sayan Nath
                </h1>

                <p className="mt-6 text-base sm:text-lg text-neutral-600 dark:text-neutral-400 leading-relaxed max-w-2xl">
