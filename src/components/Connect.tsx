    ...
    return (
        <section id="connect" className="max-w-6xl mx-auto px-6 sm:px-8 py-24">
            ...
            <div className="flex items-center gap-3">
                <svg className="w-6 h-6 text-neutral-400" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                ...
                <h2 className="text-4xl sm:text-5xl text-neutral-100 font-semibold tracking-tight">Connect</h2>
            </div>

            {/* Intro */}
            <p className="mt-4 max-w-2xl text-neutral-400 leading-relaxed">
                Always excited to collaborate on research and impactful ML projects, speak at conferences, or help teams build fair
            ...
            <div className="mt-12 grid grid-cols-1 lg:grid-cols-12 gap-12">
                ...
                <div className="lg:col-span-6 space-y-6 max-w-xl">
                    ...
                    <div className="flex items-center gap-3 text-neutral-300">
                        <svg className="w-4 h-4 text-neutral-400" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                    ...
                    <div className="flex flex-wrap items-center gap-8 text-sm">
                        <a
                         ...
                         decoration-neutral-600 hover:decoration-white
                         focus:outline-none focus-visible:ring-2 focus-visible:ring-neutral-600 rounded"
                        >
                            <svg className="w-4 h-4 opacity-80" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
                                <path d="M2 6.75A2.75 2.75 0 0 1 4.75 4h14.5A2.75 2.75 0 0 1 22 6.75v10.5A2.75 2.75 0 0 1 19.25 20H4.75A2.75 2.75 0 0 1 2 17.25V6.75Zm2.28-.53 7.02 4.39c.42.26.97.26 1.39 0l7.02-4.39a1.25 1.25 0 0 0-1.39-2.08L12 8.58 5.67 4.14a1.25 1.25 0 1 0-1.39 2.08Z" />
                            </svg>
                            Get In Touch
                        </a>
                ...
                <div className="lg:col-span-6 lg:col-start-7">
                    <p className="text-sm font-medium text-neutral-300">Open to Collaborate On</p>
                    <div className="mt-3 flex flex-wrap gap-2">
                        {TAGS.map((tag) => (
                            <span
                                key={tag}
                                className="text-[12px] tracking-wide text-neutral-300
            ...
            {/* Footer */}
            <div className="mt-20 border-t border-neutral-800 pt-6">
                <div className="flex items-start justify-between">
                    <div>
                        <p className="text-sm sm:text-base text-neutral-300">Sayan Nath</p>
                        <p className="mt-2 text-[12px] font-mono text-neutral-500">
